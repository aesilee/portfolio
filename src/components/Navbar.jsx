export default function Navbar({ activeSection }) {
  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-50 flex items-center justify-between px-8 py-4 bg-[#000013]/90 backdrop-blur-sm">
      ...
      <div className="flex items-center gap-8">
        ...
        <button className="border border-[#94A3B8]/60 text-[#F8FAFC] text-sm px-5 py-1.5 font-mono tracking-wide hover:bg-[#F8FAFC] hover:text-[#000013] transition-colors duration-200 rounded-md">
          Resume
        </button>
      </div>
    </nav>
