    ...
    <section id="home" className="relative min-h-screen flex items-center">
      ...
      <div className="w-full pt-24 pb-16 px-6 sm:px-10 lg:pl-[220px]">
        ...
        <div className="relative z-10 flex items-center gap-3 mb-5 lg:-ml-[10px]">
          ...
          <div
            id="hero-line-anchor"
            className="hidden lg:block flex-shrink-0 lg:-ml-[22px] xl:-ml-[23px] min-[1500px]:-ml-[23px] 2xl:-ml-[25px] relative z-10 px-[1px]"
          >
        ...
        {/* Name */}
        <h1 className="text-4xl sm:text-5xl lg:text-7xl font-bold text-[#F8FAFC] mb-3 leading-tight lg:ml-[10px]"
          style={{ fontFamily: "'Poppins', sans-serif", letterSpacing: "-0.02em" }}>
          Ashley Tongco
        </h1>

        {/* Title */}
        <h2 className="text-lg sm:text-2xl lg:text-3xl font-semibold text-[#94A3B8] mb-6 lg:ml-[10px]"
          style={{ fontFamily: "'Poppins', sans-serif" }}>
          Front End Developer &amp; UI/UX Designer
        </h2>

        {/* Bio */}
        <p className="text-[#F8FAFC] text-xs sm:text-sm leading-relaxed max-w-xl lg:ml-[10px]"
          style={{ fontFamily: "'JetBrains Mono', monospace" }}>
